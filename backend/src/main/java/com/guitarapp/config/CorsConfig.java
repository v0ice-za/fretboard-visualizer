...
/**
 * CORS for the credentialed cross-origin call (Vercel frontend → Railway backend).
 * {@code allowCredentials(true)} forbids a wildcard origin, so origins are an explicit
 * allow-list from {@code app.cors.allowed-origins} (comma-separated).
 */
@Configuration
